	...
	public struct KeyCombo
	{
		...
		public override string ToString()
		{
			...
			if (Enabled)
			{
				...
				if (WinMod)
				{
					ret += LibraryStrings.WinModifierKey;	//"Win";
				}
				if (ControlMod)
				{
					if (ret.Length > 0)
					...
					ret += LibraryStrings.CtrlModifierKey;	// "Ctrl";
				}
				if (ShiftMod)
				{
					if (ret.Length > 0)
					...
					ret += LibraryStrings.ShiftModifierKey;	// "Shift";
				}
				if (AltMod)
				{
					if (ret.Length > 0)
					...
					ret += LibraryStrings.AltModifierKey;	// "Alt";
				}
				if (ret.Length > 0)
				{
					ret += "+";
			...
			{
				ret = LibraryStrings.DisabledHotKey;	// "--DISABLED--";
			}
