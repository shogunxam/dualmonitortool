...
namespace DMT.Library.Settings
{
	interface ISettingsService
	{
		...
		int GetSettingAsInt(string moduleName, string settingName);
		void SetSetting(string moduleName, string settingName, int value);

		uint GetSettingAsUInt(string moduleName, string settingName);
		void SetSetting(string moduleName, string settingName, uint value);

		bool GetSettingAsBool(string moduleName, string settingName);
