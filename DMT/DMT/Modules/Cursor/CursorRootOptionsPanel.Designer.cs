...
{
	partial class CursorRootOptionsPanel
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.label3.Text = "Settings to control movement of cursor between monitors.";
			// 
			// label2
			// 
			...
			this.label1.Text = "Cursor Module";
			// 
			// pictureBox1
			// 
			this.pictureBox1.Image = global::DMT.Properties.Resources.cursor_48_24;
