...
namespace DMT.Modules.SwapScreen
{
	class SwapScreenModule : Module
	{
		...
		void Start()
		{
			...
			if (!_settingsService.SettingExists(_moduleName, UdaController.GetUdaMarkerSettingName()))
			{
		...
		{
			UdaController udaController = new UdaController(_moduleName, idx, _settingsService, _hotKeyService);
