		...
		public override string ToString()
		{
			...
			switch (Mapping)
			{
				case ImageToMonitorMapping.OneToOneBig:
					ret = Properties.Resources.OneToOneBig;
					break;

				case ImageToMonitorMapping.OneToMany:
					ret = Properties.Resources.OneToMany;
					break;

				case ImageToMonitorMapping.ManyToMany:
					ret = Properties.Resources.ManyToMany;
					break;

				case ImageToMonitorMapping.ManyToManyInSequence:
					ret = Properties.Resources.ManyToManyInSequence;
					break;
