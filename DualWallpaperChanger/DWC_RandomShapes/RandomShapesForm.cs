...
{
	/// <summary>
	/// Configuration form for a single provider from the Random Shapes plugin
	/// </summary>
	public partial class RandomShapesForm : Form
	{
		...
		{
			AboutPluginForm dlg = new AboutPluginForm(Assembly.GetExecutingAssembly(), RandomShapesPlugin.PluginImage);
			dlg.ShowDialog(this);
		}
