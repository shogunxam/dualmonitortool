...
void CLayoutManager::PaintBar(HWND hWndFloatBar, HWND hWndFrame, const CButtonList& buttonList)
{
	if (m_pCurTheme)
	{
		PAINTSTRUCT ps;
		...
		m_pCurTheme->PaintBar(hWndFloatBar, hWndFrame, hDC, buttonList, rectBar);
